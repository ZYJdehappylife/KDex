...
func printHelp() {
	fmt.Println("KDexAPI(Based NewAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: NewAPI by QuantumNous - https://kdex-api")
	fmt.Println("Maintainer: ZYJdehappylife - https://github.com/ZYJdehappylife/KDex")
