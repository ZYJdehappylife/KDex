...
const (
	...
	authTokenIssuer       = "kdex-api"
	authTokenAudience     = "kdex-api-dashboard"
)
...
func authSigningKey(purpose string) []byte {
	...
	_, _ = mac.Write([]byte("kdex-api/auth/" + purpose + "/v1"))
	return mac.Sum(nil)
}
...
// ParseDashboardAccessToken distinguishes kdex-api dashboard JWTs from opaque
